...
export default function App() {
  return (
    <>
    <main className="relative flex-1 p-6 ml-64 bg-gray-100/10 h-screen">
      <BasicDragDrop>
        ...
        <div className='bg-stone-100 w-[400px] h-[600px]'>pdf3</div>
        <div className='bg-stone-100 w-[400px] h-[600px]'>pdf4</div>
        <div className='bg-stone-100 w-[400px] h-[600px]'>pdf3</div>
        <div className='bg-stone-100 w-[400px] h-[600px]'>pdf4</div>
        <div className='bg-stone-100 w-[400px] h-[600px]'>pdf3</div>
        <div className='bg-stone-100 w-[400px] h-[600px]'>pdf4</div>
